...
local my_language = {
    ...
    property_tax_cant_afford = "Вы не смогли оплатить налоги! Ваше имущество было изъято!",
    ...
    cant_arrest_no_jail_pos = "Вы не можете арестовать игрока, так как нет позиции тюрьмы!",
    ...
    keys_everyone = "(Нажмите клавишу перезарядки, держа ключи, или F2, чтобы включить всем)",
    ...
    reset_add_jailpos = "Вы сбросили все позиции тюрьмы и создали новую здесь.",
    created_spawnpos = "Вы создали позицию возрождения %s.",
    updated_spawnpos = "Вы удалили все позиции возрождения %s и создали новую здесь",
    remove_spawnpos = "Вы удалили все позиции возрождения %s.",
    ...
    gunlicense_requested = "%s запрашивает оружейную лицензию у %s",
    gunlicense_granted = "%s выдаёт оружейную лицензию %s",
    ...
    x_set_your_salary_to_y = "%s меняет вашу зарплату в %s%d.",
